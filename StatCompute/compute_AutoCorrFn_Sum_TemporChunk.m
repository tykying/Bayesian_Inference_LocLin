function [Autocorr_Sum_TemporChunk, AvailSample_TemporChunk] = compute_AutoCorrFn_Sum_TemporChunk(TrajData, TrajPosition, VelocData, TransitStat_Part, Mesh_Struct)
%% Explanation:
...
NCpn = 5;
ChunkBinResideIntv_min = 3;
TemporChunk_MaxLength = 180;
...
for part = 1:nparticles
    ...
    for Chunk_ind = 1:AvailChunk      
        ...
        Chunk_i_tf = min(Chunk_i_ti+TemporChunk_MaxLength, Nts);  % In the time-series of position, not diff(position)!
