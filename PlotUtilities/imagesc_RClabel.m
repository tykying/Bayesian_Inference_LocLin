function ax_sp = imagesc_RClabel(grid_vis, Data_ij_vis_List, row_CLim, YLabelString_List, TitleString_List)
...
for c_ind = 1:Ncol
    for r_ind = 1:Nrow
        ...
        imagesc_sp = imagesc(ax_spc, grid_vis.X(:,1), grid_vis.Y(1,:), Data_ij_vis_List{r_ind, c_ind}');
